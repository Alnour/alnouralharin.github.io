      ...
      <div className="container relative z-10 px-6 md:px-12 max-w-6xl">
        <div className="grid lg:grid-cols-[1.2fr_0.8fr] gap-12 items-center">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-serif leading-[1.1] tracking-tight text-foreground mix-blend-normal transition-colors duration-500">
              Layers on Layers <br />
              <span className="text-foreground/60">on Layers</span>
            </h1>
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              {["Machine Learning", "Software Engineering", "Agentic Programming", "RAG"].map((tag, i) => (
                <span key={i} className="px-3 py-1 text-xs font-mono border border-border rounded bg-card/50 text-foreground/70">
                  {tag}
                </span>
              ))}
            </div>
